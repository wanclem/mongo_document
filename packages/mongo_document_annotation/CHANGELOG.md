...
- Added persisted document snapshots to support immutable partial-update flows generated by `mongo_document`.
- Improved lookup and projection normalization, including base-projection preservation, field remapping, and direct-find-compatible projection handling.
- Expanded typed object-reference, lookup, projection, troubleshooting, and LLM-oriented documentation.
