...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@ObjectIdConverter()@JsonKey(name: '_id')  ObjectId? id,  String? tempId,  User? owner,  String? name,  dynamic avatar,  Map<String, dynamic> ephemeralData,  bool active, @DateTimeConverter()  DateTime? createdAt, @DateTimeConverter()  DateTime? updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Organization() when $default != null:
return $default(_that.id,_that.tempId,_that.owner,_that.name,_that.avatar,_that.ephemeralData,_that.active,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@ObjectIdConverter()@JsonKey(name: '_id')  ObjectId? id,  String? tempId,  User? owner,  String? name,  dynamic avatar,  Map<String, dynamic> ephemeralData,  bool active, @DateTimeConverter()  DateTime? createdAt, @DateTimeConverter()  DateTime? updatedAt)  $default,) {final _that = this;
switch (_that) {
case _Organization():
return $default(_that.id,_that.tempId,_that.owner,_that.name,_that.avatar,_that.ephemeralData,_that.active,_that.createdAt,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@ObjectIdConverter()@JsonKey(name: '_id')  ObjectId? id,  String? tempId,  User? owner,  String? name,  dynamic avatar,  Map<String, dynamic> ephemeralData,  bool active, @DateTimeConverter()  DateTime? createdAt, @DateTimeConverter()  DateTime? updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _Organization() when $default != null:
return $default(_that.id,_that.tempId,_that.owner,_that.name,_that.avatar,_that.ephemeralData,_that.active,_that.createdAt,_that.updatedAt);case _:
  return null;
