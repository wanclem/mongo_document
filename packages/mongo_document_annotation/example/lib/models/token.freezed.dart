...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@ObjectIdConverter()@JsonKey(name: '_id')  ObjectId? id,  String? ownerEmail,  String? token,  Map<String, dynamic>? data,  String? reason,  String? description,  int? numberOfUpdates, @DateTimeConverter()  DateTime? expireAt, @DateTimeConverter()  DateTime? createdAt, @DateTimeConverter()  DateTime? updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Token() when $default != null:
return $default(_that.id,_that.ownerEmail,_that.token,_that.data,_that.reason,_that.description,_that.numberOfUpdates,_that.expireAt,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@ObjectIdConverter()@JsonKey(name: '_id')  ObjectId? id,  String? ownerEmail,  String? token,  Map<String, dynamic>? data,  String? reason,  String? description,  int? numberOfUpdates, @DateTimeConverter()  DateTime? expireAt, @DateTimeConverter()  DateTime? createdAt, @DateTimeConverter()  DateTime? updatedAt)  $default,) {final _that = this;
switch (_that) {
case _Token():
return $default(_that.id,_that.ownerEmail,_that.token,_that.data,_that.reason,_that.description,_that.numberOfUpdates,_that.expireAt,_that.createdAt,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@ObjectIdConverter()@JsonKey(name: '_id')  ObjectId? id,  String? ownerEmail,  String? token,  Map<String, dynamic>? data,  String? reason,  String? description,  int? numberOfUpdates, @DateTimeConverter()  DateTime? expireAt, @DateTimeConverter()  DateTime? createdAt, @DateTimeConverter()  DateTime? updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _Token() when $default != null:
return $default(_that.id,_that.ownerEmail,_that.token,_that.data,_that.reason,_that.description,_that.numberOfUpdates,_that.expireAt,_that.createdAt,_that.updatedAt);case _:
  return null;
