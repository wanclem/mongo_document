...
const keyApplication = 'application';
const keyAppName = 'appName';
...
const keyAuthenticate = 'authenticate';
...
const keyDriverInfo = 'driverInfo';
const keyDrop = 'drop';
...
const keyLoadBalanced = "loadBalanced";
