...
import 'package:mongo_document_db/src/database/commands/aggregation_commands/count/count_operation.dart';
import 'package:mongo_document_db/src/database/commands/aggregation_commands/count/count_options.dart';
...
import 'package:mongo_document_db/src/database/commands/query_and_write_operation_commands/get_more_command/get_more_command.dart';
import 'package:mongo_document_db/src/database/commands/parameters/read_concern.dart';
  ...
  group('Aggregate', () {
    ...
    group(r'$setWindowFields', () {
      test('output the cumulative cake sales quantity for each state',
        ...
        var ret = await insertCakeSales(collection);
        expect(ret.ok, 1.0);
        expect(ret.isSuccess, isTrue);
        ...
        final pipeline = AggregationPipelineBuilder()
            .addStage(SetWindowFields(
                partitionBy: r'$state',
                sortBy: {'orderDate': 1},
                output: Output('cumulativeQuantityForState', Sum(r'$quantity'),
                    documents: ['unbounded', 'current'])))
            .build();
        var res = await collection.modernAggregate(pipeline).toList();
