...
- Fixed bug preventing pre 3.6 releases to work with mongo_document_db
...
- The hidden class `_Connection` has been renamed `Connection`. If you have already your own Connection class may be that they conflict. In this case, you shoul hide the `Connection` class while importing MongoDart in your sources. Ex.```dart import 'package:mongo_document_db/mongo_document_db.dart' hide Connection;```
...
- `authSource` connection string option added See: <https://github.com/vadimtsushko/mongo_document_db/issues/72>
...
- Fix issue [71](https://github.com/vadimtsushko/mongo_document_db/issues/71) - Logger allocates lot of strings
...
- Bugfix for [Issue 51](https://github.com/vadimtsushko/mongo_document_db/issues/51) Can't reopen a closed database
- API docs redirected to dartdocs.org [Issue 48](https://github.com/vadimtsushko/mongo_document_db/issues/48)

### 0.1.40

- Better error handling when a connection with the database is lost. Thanks to [luizmineo](https://github.com/luizmineo) [PR 50](https://github.com/vadimtsushko/mongo_document_db/pull/50).
- `Future(List<String>) listCollections()` helper added to Db
- `Future(List<String>) listDatabases()` helper added to Db

### 0.1.39

- Better error handling. Bugfix for [issue 49](https://github.com/vadimtsushko/mongo_document_db/issues/49)
...
getLastError(). See <https://github.com/vadimtsushko/mongo_document_db/issues/41>
...
- Bugfix to [fields() issue](https://github.com/vadimtsushko/mongo_document_db/issues/26). Fields clause in find(), findOne() methods did not work.
...
- mongo_dart_query published separately and added as dependency to mongo_document_db. Unified SelectorBuilder will be used by mongo_document_db and objectory.  

### 0.1.14

- Bson library published separately and added as dependency to mongo_document_db  
...
- Bug fix on [Issue 18](https://github.com/vadimtsushko/mongo_document_db/issues/18) about db.ensureIndex
...
- $err field set in MongoDB result object raises Error in mongo_document_db
