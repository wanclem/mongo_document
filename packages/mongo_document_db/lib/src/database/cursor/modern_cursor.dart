...
import 'package:mongo_document_db/src/database/commands/administration_commands/kill_cursors_command/kill_cursors_command.dart';
import 'package:mongo_document_db/src/database/commands/aggregation_commands/aggregate/return_classes/change_event.dart';
import 'package:mongo_document_db/src/database/commands/aggregation_commands/wrapper/change_stream/change_stream_handler.dart';
...
import 'package:mongo_document_db/src/database/commands/query_and_write_operation_commands/get_more_command/get_more_options.dart';

import '../../../mongo_document_db.dart';
...
class ModernCursor {
  ...
  Future<Map<String, dynamic>?> nextObject() async {
    ...
    cursorId = cursorMap == null
        ? Int64.ZERO
        : ((cursorMap[keyId] as Int64?) ?? Int64.ZERO);
